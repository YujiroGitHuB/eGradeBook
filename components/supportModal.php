    ...
    whatsnew: {
      ...
      html:
        ...
        '<ul>' +
          ...
          '<li><strong>Ties no longer skip a number.</strong> Students with the same grade are grouped under one rank, and the next student is the very next number: two students tied at #1 are followed by #2, not #3. <em>Top 3</em> and <em>Top 10</em> count students, and anyone tied at the cutoff is included. Links you already shared keep the old numbers until you press <strong>Update link</strong> or <strong>Update all sections</strong>.</li>' +
